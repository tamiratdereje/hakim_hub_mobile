...
import 'package:hakim_hub_mobile/features/hospital/domain/usecases/get_all_hospitals.dart';
...
void main() {
  ...
  test(
    ...
    () async {
      ...
      verify(mockRepository.getAllHospitals());
